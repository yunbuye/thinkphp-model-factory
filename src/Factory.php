...
class Factory implements ArrayAccess
{
     ...
     */
    public function __construct(Faker $faker = null, $pathToFactories = null)
    {
        if (empty($faker)) {
            $faker = \Faker\Factory::create(Config::get('app.faker_locale', 'zh_CN'));
        }
        $this->faker = $faker;
        $pathToFactories = $pathToFactories ?: Env::get('root_path') . 'database' . DIRECTORY_SEPARATOR . 'factories' . DIRECTORY_SEPARATOR;
        $this->load($pathToFactories);
    }
