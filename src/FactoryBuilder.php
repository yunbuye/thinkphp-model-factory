...
class FactoryBuilder
{
    ...
    public function make(array $attributes = [])
    {
         ...
         */
        if ($this->amount < 1) {
            return new Collection([$this->makeInstance([])]);
        }

        $instances = new Collection(array_map(function () use ($attributes) {
